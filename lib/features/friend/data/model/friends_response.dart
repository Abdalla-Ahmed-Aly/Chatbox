...
String friendsResponseToJson(FriendsResponse data) =>
    json.encode(data.toJson());

class FriendsResponse {
  FriendsResponse({required this.success, required this.results});

  bool success;
  Results results;

  factory FriendsResponse.fromJson(Map<dynamic, dynamic> json) =>
      FriendsResponse(
...
class ProfilePic {
  ...
  factory ProfilePic.fromJson(Map<dynamic, dynamic> json) =>
      ProfilePic(secureUrl: json["secure_url"], publicId: json["public_id"]);
