import 'package:chatbox/features/callForChat/presentation/screens/widget/ring_icon.dart';
...
children: [
  ...
  RingIcon(title: "Message",iconPath: "message",onPress: ()=> Navigator.pushNamed(context, ChatScreen.routeName),),
